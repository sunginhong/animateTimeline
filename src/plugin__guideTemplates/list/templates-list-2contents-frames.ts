...
export function templatesListContentsFrame({ parent }) {
    ...
    templatesListTitle({ parent: DescriptionFrame, label: "Curve 가이드", cases: "Description" });
    templatesListTitle({ parent: DescriptionFrame, label: "haptic 가이드", cases: "Description" });
    templatesListTitle({ parent: DescriptionFrame, label: "가이드", cases: "Description" });
}