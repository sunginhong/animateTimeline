import { templatesListFrame } from './create-guide-templates-list/templates-list-frames';

export const createGuideTemplatesList = (msg) => {
    ...
    templatesListFrame({parents: list});
}